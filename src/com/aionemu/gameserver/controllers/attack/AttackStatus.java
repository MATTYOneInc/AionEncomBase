...
public enum AttackStatus {
	...
	BLOCK(4, true, false), OFFHAND_BLOCK(5, true, false), RESIST(6, true, false), OFFHAND_RESIST(7), BUF(8),
	OFFHAND_BUF(9), NORMALHIT(10), OFFHAND_NORMALHIT(11), CRITICAL_DODGE(192, true, true),
	CRITICAL_PARRY(194, true, true), CRITICAL_BLOCK(196, true, true), CRITICAL_RESIST(198, false, true),
	CRITICAL(202, false, true), OFFHAND_CRITICAL_DODGE(209, true, true), OFFHAND_CRITICAL_PARRY(211, true, true),
	OFFHAND_CRITICAL_BLOCK(213, true, true), OFFHAND_CRITICAL_RESIST(215, false, true),
