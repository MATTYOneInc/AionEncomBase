	...
	public static final void enterWorld(AionConnection client, int objectId) {
		...
		if (player != null && client.setActivePlayer(player)) {
			...
			*/
			...
			PacketSendUtility.sendMessage(player, "");
			PacketSendUtility.sendMessage(player, "============================");
			PacketSendUtility.sendBrightYellowMessageOnCenter(player, "Welcome to " + GSConfig.SERVER_NAME);
			PacketSendUtility.sendMessage(player, "============================");
            PacketSendUtility.sendYellowMessage(player, ColorChat.colorChat("Power by Encom", "1 1 9 0"));
			PacketSendUtility.sendMessage(player, "============================");
