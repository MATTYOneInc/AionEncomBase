...
public final class PlatformDependent {
	...
	static {
		...
		if (!hasUnsafe()) {
			logger.warn("Your platform does not provide complete low-level API for accessing direct buffers reliably. " + "Unless explicitly requested, heap buffer will always be preferred "
	...
	/**
	 * Try to deallocate the specified direct {@link ByteBuffer}. Please note this method does nothing if the current platform does not support this
